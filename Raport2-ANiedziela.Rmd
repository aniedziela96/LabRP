...
Czyli stritów możemy ułożyć `r straight` - `r 4 * 4 * 4 * 3 + 4 * 4 * 4 * 3 + 3 * 4^4 * 3 + 2 * 4^4` = `r straight - (4 * 4 * 4 * 3 + 4 * 4 * 4 * 3 + 3 * 4^4 * 3 + 2 * 4^4)`
